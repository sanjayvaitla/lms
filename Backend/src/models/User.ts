...
export class User extends Model {
  ...
  @Default('STUDENT')
  @Column(DataType.TEXT)
  declare role: 'SUPER_ADMIN' | 'ADMIN' | 'LD_MANAGER' | 'OPERATIONAL_MANAGER' | 'OPS_MANAGER' | 'FEES_ADMIN' | 'TRAINER' | 'STUDENT' | 'INTERN';
  ...
  @AllowNull(true)
  @Unique
  @Column({ field: 'github_id', type: DataType.TEXT })
  declare githubId: string | null;

  @AllowNull(true)
  @Unique
  @Column({ field: 'github_username', type: DataType.TEXT })
  declare githubUsername: string | null;

  @AllowNull(true)
  @Column({ field: 'github_access_token', type: DataType.TEXT })
