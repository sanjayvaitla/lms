...
export declare function updateEnrollment(req: Request, res: Response): Promise<void>;
export declare function availableStudents(req: Request, res: Response): Promise<void>;
export declare function analytics(req: Request, res: Response): Promise<void>;
